...
const DUMMY_PRODUCTS = [
  {
    ...
    era: "1990s",
    defectGrade: "Ringan",
    defectDesc: "Terdapat noda kuning kecil diameter 0.5cm di kerah bagian dalam. Warna sedikit pudar (5%) karena pemakaian wajar.",
    purificationStatus: "Telah disucikan secara syar'i (dicuci bersih dengan air mengalir untuk menghilangkan najis, disetrika uap suhu tinggi, dan disinfeksi).",
    isPurified: true,
    image: "https://images.unsplash.com/photo-1551028719-00167b16eac5?q=80&w=600&auto=format&fit=crop"
  },
  {
    id: 2,
    name: "Retro Modest Dress",
    category: "Dress",
    price: 120000,
    size: "M",
    condition: "Sangat Baik",
    era: "1980s",
    defectGrade: "Tidak Ada",
    defectDesc: "Kondisi sangat mulus tanpa cacat serat kain maupun jahitan.",
    purificationStatus: "Telah disucikan secara syar'i (dicuci bersih dengan air mengalir, disetrika uap suhu tinggi, dan disinfeksi).",
    isPurified: true,
  ...
  },
  {
    ...
    era: "1990s",
    defectGrade: "Ringan",
    defectDesc: "Baret halus pemakaian wajar di bagian kulit bawah tas, besi gesper sedikit pudar warnanya.",
    purificationStatus: "Disanitasi & Sterilisasi khusus bahan kulit menggunakan pembersih khusus (Bebas kuman & Suci).",
    isPurified: true,
  ...
  },
  {
    ...
    era: "1980s",
    defectGrade: "Sedang",
    defectDesc: "Sol sedikit aus di bagian tumit, tapi masih sangat nyaman dan layak pakai.",
    purificationStatus: "Disanitasi bagian luar dan dalam dengan desinfektan standar syar'i.",
    isPurified: true,
    image: "https://images.unsplash.com/photo-1543163521-1bf539c55dd2?q=80&w=600&auto=format&fit=crop"
  },
  {
    id: 5,
    name: "Oversized Flannel Kemeja",
    category: "Kemeja",
    price: 85000,
    size: "XL",
    condition: "Baik",
    era: "1990s",
    defectGrade: "Ringan",
    defectDesc: "Ada jahitan kurang rapi di ujung bawah baju dari pabrikan asli, tidak memengaruhi tampilan luar.",
    purificationStatus: "Telah disucikan secara syar'i (dicuci bersih dengan air mengalir, disetrika uap suhu tinggi, dan disinfeksi).",
    isPurified: true,
  ...
  },
  {
    ...
    era: "Modern",
    defectGrade: "Tidak Ada",
    defectDesc: "Tidak ada bekas peniti, benang masih sangat rapi.",
    purificationStatus: "Telah disucikan secara syar'i (dicuci bersih dengan air mengalir, disetrika uap suhu tinggi, dan disinfeksi).",
    isPurified: true,
    image: "https://images.unsplash.com/photo-1589363460779-cbdf1f38e6e8?q=80&w=600&auto=format&fit=crop"
  }
];
