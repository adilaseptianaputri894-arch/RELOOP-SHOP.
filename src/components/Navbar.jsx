...
export default function Navbar() {
  ...
  return (
    <nav className="border-b border-foreground/10 px-6 md:px-8 py-4 flex justify-between items-center backdrop-blur-md sticky top-0 z-50 bg-background/80">
      <Link href="/" className="text-2xl font-bold tracking-widest uppercase font-sans">
        RELOOP{" "}
      ...
      <div className="flex gap-6 items-center text-foreground/80">
        <Link href="/" title="Beranda" className="hover:text-accent transition-colors hidden md:block">
          <Home size={20} strokeWidth={1.5} />
        </Link>
        <Link href="/katalog" title="Koleksi" className="hover:text-accent transition-colors">
        ...
        {isAdmin && (
          <>
            <Link href="/jual" title="Jual Barang" className="hover:text-accent transition-colors">
              <PlusCircle size={20} strokeWidth={1.5} />
            </Link>
            <Link href="/pos" title="POS Kasir" className="hover:text-accent transition-colors">
              <Calculator size={20} strokeWidth={1.5} />
            </Link>
            <Link href="/laporan" title="Laporan Keuangan" className="hover:text-accent transition-colors">
        ...
        <Link href="/pesanan" title="Pesanan Saya" className="hover:text-accent transition-colors">
          <Package size={20} strokeWidth={1.5} />
        </Link>

        <Link href="/cart" title="Keranjang" className="hover:text-accent transition-colors relative">
